...
if(isset($_GET['open'])) {
	switch($_GET['open']){				
		...
		case 'Data-Admin' :				
			if(!file_exists ("data_admin.php")) die ("Sorry Empty Page!"); 
			include "data_admin.php"; break;
		...
		case 'Laporan' :	
			...
			case 'Laporan-Lunas' :
				if(!file_exists ("laporan_lunas.php")) die ("Sorry Empty Page!"); 
				include "laporan_lunas.php"; break;
		...
		case 'backup-database' :	
			if(!file_exists ("backup.php")) die ("Sorry Empty Page!"); 
				include "backup.php";	break;	
			
			case 'backup-proses' :	
			if(!file_exists ("backup_proses.php")) die ("Sorry Empty Page!"); 
				include "backup_proses.php";	break;		
